fun main() {
    ...
    val newLinkedList = LinkedList(node01)
    println(newLinkedList.toString())
    newLinkedList.linkedListAppendNode(node02)
    println(newLinkedList.toString())
    newLinkedList.linkedListAppendNode(node03)
    println(newLinkedList.toString())
    newLinkedList.linkedListAppendNode(node04)
    println(newLinkedList.toString())
    newLinkedList.linkedListAppendNode(node05)
    println(newLinkedList.toString())
    println(newLinkedList.linkedListSize)
...
private fun resultChallengeSalesDepartment() {
    println(totalSales(listOf("8349,14/09/2024,899.9,ESPORTE",
